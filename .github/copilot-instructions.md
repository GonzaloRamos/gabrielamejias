...
- The page depends on vendored assets via absolute paths:
...
- Preserve the existing absolute `/lib/...` asset references unless deployment behavior changes. They are part of how the static page resolves vendored files.
